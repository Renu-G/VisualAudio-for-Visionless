...
def speak(str1):
    ...
    speak.Speak(str1)
base_model = InceptionV3(weights = r'inception_v3_weights_tf_dim_ordering_tf_kernels.h5')
...
background_image = tk.PhotoImage(file=r'C:\Users\DELL\Documents\image-caption-generator-using-deep-learning-master\eye.png')
